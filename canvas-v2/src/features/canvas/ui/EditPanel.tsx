...
export const EditPanel = memo(({ node, isOpen, onClose, buttonRect }: EditPanelProps) => {
  ...
  return (
    <div
      className="canvas-floating-tool-panel fixed z-[100] min-w-[300px] rounded-xl border border-[rgba(255,255,255,0.18)] bg-surface-dark/95 p-2 shadow-2xl backdrop-blur-sm"
      style={{
